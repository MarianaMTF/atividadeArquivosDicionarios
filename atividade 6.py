...
def opcao(estudantes, arquivo):
    while True:
        r=int(input(("digite 1 para adicionar estudantes, 2 paraver o arquivo, 3 para atualizar, 4 para ver informações do aluno, 5 para remover um estudante, 6 para ver a media das idades, 0 para encerrar:")))
        if r==1:
